...
class MysqlCli:
    ...
    def operate(self,sql,param=None)->int:
        ...
        try:
            ...
            log.logger.error(f"operate error: {e},sql:{sql},param:{param}")
            raise Exception(f"operate error: {e},sql:{sql},param:{param}")
    ...
    def operate_many(self,sql,params=None)->int:
        ...
        try:
            ...
            self.connect.rollback()
            log.logger.error(f"operate_many error: {e},sql:{sql},param:{params}")
            raise Exception(f"operate_many error: {e},sql:{sql},params:{params}")
    ...
    def select_one(self,sql,params=None)->dict:
        ...
        try:
          ...
          return res
            ...
            self.connect.rollback()
            log.logger.error(f"select_one error: {e},sql:{sql},param:{params}")
            raise Exception(f"select_one error: {e},sql:{sql},param:{params}")
    ...
    def select_all(self,sql,params=None)->list:
        ...
        try:
          ...
          return res
            ...
            self.connect.rollback()
            log.logger.error(f"select_all error: {e},sql:{sql},param:{params}")
            raise Exception(f"select_all error: {e},sql:{sql},param:{params}")
